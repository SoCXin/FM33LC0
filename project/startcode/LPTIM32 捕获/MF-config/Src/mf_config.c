...
void MF_LPTIM32_Init(void)
{
    ...
    defaultInitStruct.autoReload = 1000000;
...
void MF_LPTIM32_Channel1_Init(void)
{
    ...
    FL_LPTIM32_IC_InitTypeDef    defaultInitStruct;
    ...
    defaultInitStruct.ICSource = FL_LPTIM32_IC_CAPTURE_SOURCE_GROUP0;
    defaultInitStruct.ICEdge = FL_LPTIM32_IC_EDGE_RISING;

    FL_LPTIM32_IC_Init(LPTIM32,FL_LPTIM32_CHANNEL_1,&defaultInitStruct );
