...
void MF_UART0_Init(void)
{
    ...
    defaultInitStruct.baudRate = 2400;
...
void MF_UART0_InfraredModulate_Init(void)
{
    ...
    /*IO CONFIG*/
    FL_UART_InfraRed_InitTypeDef    InfraredModulateInitStruct;

    InfraredModulateInitStruct.polarity = FL_UART_INFRARED_POLARITY_NORMAL;
    InfraredModulateInitStruct.modulationDuty = 50;
    InfraredModulateInitStruct.modulationFrequency = 38000;

    FL_UART_InfraRed_Init(UART0,&InfraredModulateInitStruct );
